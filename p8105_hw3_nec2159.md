...
In the distribution of average rental prices in 2023 plot, we can see
the distributions of average rental prices grouped by month and zip code
for each borough. We see that Manhattan has the widest range of average
...
full_df |> 
  ...
  geom_boxplot(color = "purple", aes(fill = sex)) +
  labs(
    x = "Education",
    y = "Age",
...
40 and a dip around age 60 for both males and females. It makes sense
